...
export default function JobDetailPage() {
  ...
  useEffect(() => {
    ...
    jobs
      .get(id)
      .then((res: any) => {
        // ✅ supports both direct object & axios response
        setJob(res?.data ?? res);
      })
      .catch(() => {
        setJob(null);
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {error && (
        <div className="mt-4 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-sm px-3 py-2">
          {error}
        </div>
      )}
